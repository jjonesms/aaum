...
if((Get-AzContext).Environment.Name -eq 'AzureUSGovernment'){
    $PostURI = "https://management.usgovcloudapi.net/$RESOURCEID/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation?api-version=2018-07-01-preview"
}
else{
